...
import SelectWorkoutDay from '../../components/selectWorkoutDay';
    ...
    <View style={styles.centeredContainer}>
      ...
      {duoUsers ? (
        <>
          ...
          <View style={{ marginTop: 12 }}>
            <Text style={styles.userLabel}>
              {duoUsers[0].Username}'s Current Streak: {streakUser1 !== null ? streakUser1 : 'Loading...'}
            </Text>
            <Text style={styles.userLabel}>
              {duoUsers[1].Username}'s Current Streak: {streakUser2 !== null ? streakUser2 : 'Loading...'}
            </Text>
          </View>
        </>
      ) : soloUser ? (
        <>
          ...
          <Text style={[styles.userLabel, { marginTop: 12 }]}>
            Your Current Streak: {streakUser1 !== null ? streakUser1 : 'Loading...'}
          </Text>
        </>
      ) : (
